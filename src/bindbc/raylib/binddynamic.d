...
extern (C) @nogc nothrow {
   ...
   alias pUnloadFileText = void function(ubyte* text);
   ...
   alias pDrawLineStrip = void function(Vector2* points, int pointsCount, Color color);
   ...
   alias pDrawTriangleFan = void function(Vector2* points, int pointsCount, Color color);
   ...
   alias pLoadImagePalette = Color* function(Image image, int maxPaletteSize, int* colorsCount);
   ...
   alias pDrawTexturePoly = void function(Texture2D texture, Vector2 center, Vector2* points, Vector2* texcoords, int pointsCount, Color tint);
   ...
   alias pLoadFontFromMemory = Font function(const(char)* fileType, const(ubyte)* fileData, int dataSize, int fontSize, int* fontChars, int charsCount);
   alias pLoadFontData = CharInfo* function(const(ubyte)* fileData, int dataSize, int fontSize, int* fontChars, int charsCount, int type);
   ...
   alias pUnloadFontData = void function(CharInfo* chars, int charsCount);
   ...
   alias pDrawTextRecEx = void function(Font font, const(char)* text, Rectangle rec, float fontSize, float spacing, bool wordWrap, Color tint);
   ...
   alias pDrawTriangleStrip3D = void function(Vector3* points, int pointsCount, Color color);
   ...
   alias pDrawBillboardRec = void function(Camera camera, Texture2D texture, Rectangle source, Vector3 center, float size, Color tint);
   ...
   alias pGetCollisionRayMesh = RayHitInfo function(Ray ray, Mesh mesh, Matrix transform);
...
__gshared {
   ...
   pGetCollisionRayMesh GetCollisionRayMesh;
...
RaylibSupport loadRaylib(const(char)* libName) {
   ...
   lib.bindSymbol(cast(void**)&GetCollisionRayMesh, "GetCollisionRayMesh");
