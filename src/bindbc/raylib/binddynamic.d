...
extern (C) @nogc nothrow {
   ...
   alias pToggleBorderlessWindowed = void function();
   ...
   alias pSetWindowMaxSize = void function(int width, int height);
   alias pSetWindowSize = void function(int width, int height);
   alias pSetWindowOpacity = void function(float opacity);
   alias pSetWindowFocused = void function();
   alias pGetWindowHandle = void* function();
   alias pGetScreenWidth = int function();
   alias pGetScreenHeight = int function();
   alias pGetRenderWidth = int function();
   alias pGetRenderHeight = int function();
   ...
   alias pEnableEventWaiting = void function();
   alias pDisableEventWaiting = void function();
   ...
   alias pWaitTime = void function(double seconds);
   alias pSetRandomSeed = void function(uint seed);
   alias pGetRandomValue = int function(int min, int max);
   alias pLoadRandomSequence = int* function(uint count, int min, int max);
   alias pUnloadRandomSequence = void function(int* sequence);
   ...
   alias pLoadFileData = ubyte* function(const(char)* fileName, int* dataSize);
   alias pUnloadFileData = void function(ubyte* data);
   alias pSaveFileData = bool function(const(char)* fileName, void* data, int dataSize);
   alias pExportDataAsCode = bool function(const(ubyte)* data, int dataSize, const(char)* fileName);
   ...
   alias pGetFileLength = int function(const(char)* fileName);
   ...
   alias pGetApplicationDirectory = const(char)* function();
   alias pChangeDirectory = bool function(const(char)* dir);
   alias pIsPathFile = bool function(const(char)* path);
   alias pLoadDirectoryFiles = FilePathList function(const(char)* dirPath);
   alias pLoadDirectoryFilesEx = FilePathList function(const(char)* basePath, const(char)* filter, bool scanSubdirs);
   alias pUnloadDirectoryFiles = void function(FilePathList files);
   alias pIsFileDropped = bool function();
   alias pLoadDroppedFiles = FilePathList function();
   alias pUnloadDroppedFiles = void function(FilePathList files);
   alias pGetFileModTime = long function(const(char)* fileName);
   alias pCompressData = ubyte* function(const(ubyte)* data, int dataSize, int* compDataSize);
   alias pDecompressData = ubyte* function(const(ubyte)* compData, int compDataSize, int* dataSize);
   alias pEncodeDataBase64 = char* function(const(ubyte)* data, int dataSize, int* outputSize);
   alias pDecodeDataBase64 = ubyte* function(const(ubyte)* data, int* outputSize);
   alias pLoadAutomationEventList = AutomationEventList function(const(char)* fileName);
   alias pUnloadAutomationEventList = void function(AutomationEventList* list);
   alias pExportAutomationEventList = bool function(AutomationEventList list, const(char)* fileName);
   alias pSetAutomationEventList = void function(AutomationEventList* list);
   alias pSetAutomationEventBaseFrame = void function(int frame);
   alias pStartAutomationEventRecording = void function();
   alias pStopAutomationEventRecording = void function();
   alias pPlayAutomationEvent = void function(AutomationEvent event);
   alias pIsKeyPressed = bool function(int key);
   alias pIsKeyPressedRepeat = bool function(int key);
   ...
   alias pGetMouseWheelMoveV = Vector2 function();
   ...
   alias pIsGestureDetected = bool function(uint gesture);
   ...
   alias pDrawCircleLinesV = void function(Vector2 center, float radius, Color color);
   ...
   alias pDrawSplineLinear = void function(Vector2* points, int pointCount, float thick, Color color);
   alias pDrawSplineBasis = void function(Vector2* points, int pointCount, float thick, Color color);
   alias pDrawSplineCatmullRom = void function(Vector2* points, int pointCount, float thick, Color color);
   alias pDrawSplineBezierQuadratic = void function(Vector2* points, int pointCount, float thick, Color color);
   alias pDrawSplineBezierCubic = void function(Vector2* points, int pointCount, float thick, Color color);
   alias pDrawSplineSegmentLinear = void function(Vector2 p1, Vector2 p2, float thick, Color color);
   alias pDrawSplineSegmentBasis = void function(Vector2 p1, Vector2 p2, Vector2 p3, Vector2 p4, float thick, Color color);
   alias pDrawSplineSegmentCatmullRom = void function(Vector2 p1, Vector2 p2, Vector2 p3, Vector2 p4, float thick, Color color);
   alias pDrawSplineSegmentBezierQuadratic = void function(Vector2 p1, Vector2 c2, Vector2 p3, float thick, Color color);
   alias pDrawSplineSegmentBezierCubic = void function(Vector2 p1, Vector2 c2, Vector2 c3, Vector2 p4, float thick, Color color);
   alias pGetSplinePointLinear = Vector2 function(Vector2 startPos, Vector2 endPos, float t);
   alias pGetSplinePointBasis = Vector2 function(Vector2 p1, Vector2 p2, Vector2 p3, Vector2 p4, float t);
   alias pGetSplinePointCatmullRom = Vector2 function(Vector2 p1, Vector2 p2, Vector2 p3, Vector2 p4, float t);
   alias pGetSplinePointBezierQuad = Vector2 function(Vector2 p1, Vector2 c2, Vector2 p3, float t);
   alias pGetSplinePointBezierCubic = Vector2 function(Vector2 p1, Vector2 c2, Vector2 c3, Vector2 p4, float t);
   ...
   alias pLoadImageSvg = Image function(const(char)* fileNameOrString, int width, int height);
   ...
   alias pExportImageToMemory = ubyte* function(Image image, const(char)* fileType, int* fileSize);
   ...
   alias pGenImageGradientLinear = Image function(int width, int height, int direction, Color start, Color end);
   alias pGenImageGradientRadial = Image function(int width, int height, float density, Color inner, Color outer);
   alias pGenImageGradientSquare = Image function(int width, int height, float density, Color inner, Color outer);
   ...
   alias pImageRotate = void function(Image* image, int degrees);
   ...
   alias pLoadFontEx = Font function(const(char)* fileName, int fontSize, int* codepoints, int codepointCount);
   alias pLoadFontFromImage = Font function(Image image, Color key, int firstChar);
   alias pLoadFontFromMemory = Font function(const(char)* fileType, const(ubyte)* fileData, int dataSize, int fontSize, int* codepoints, int codepointCount);
   alias pIsFontReady = bool function(Font font);
   alias pLoadFontData = GlyphInfo* function(const(ubyte)* fileData, int dataSize, int fontSize, int* codepoints, int codepointCount, int type);
   alias pGenImageFontAtlas = Image function(const GlyphInfo* glyphs, Rectangle** glyphRecs, int glyphCount, int fontSize, int padding, int packMethod);
   alias pUnloadFontData = void function(GlyphInfo* glyphs, int glyphCount);
   alias pUnloadFont = void function(Font font);
   alias pExportFontAsCode = bool function(Font font, const(char)* fileName);
   ...
   alias pDrawTextCodepoints = void function(Font font, const(int)* codepoints, int codepointCount, Vector2 position, float fontSize, float spacing, Color tint);
   alias pSetTextLineSpacing = void function(int spacing);
   ...
   alias pUpdateMeshBuffer = void function(Mesh mesh, int index, const(void)* data, int dataSize, int offset);
   alias pUnloadMesh = void function(Mesh mesh);
   alias pDrawMesh = void function(Mesh mesh, Material material, Matrix transform);
   alias pDrawMeshInstanced = void function(Mesh mesh, Material material, const Matrix* transforms, int instances);
   ...
   alias pLoadModelAnimations = ModelAnimation* function(const(char)* fileName, int* animCount);
   ...
   alias pUnloadModelAnimations = void function(ModelAnimation* animations, int animCount);
   ...
   alias pGetMasterVolume = float function();
   ...
   alias pLoadSoundAlias = Sound function(Sound source);
   ...
   alias pUnloadSoundAlias = void function(Sound aka);
   ...
   alias pSetSoundPan = void function(Sound sound, float pan);
   ...
   alias pSetMusicPan = void function(Music music, float pan);
   ...
   alias pSetAudioStreamPan = void function(AudioStream stream, float pan);
...
__gshared {
   ...
   pToggleBorderlessWindowed ToggleBorderlessWindowed;
   ...
   pSetWindowMaxSize SetWindowMaxSize;
   pSetWindowSize SetWindowSize;
   pSetWindowOpacity SetWindowOpacity;
   pSetWindowFocused SetWindowFocused;
   pGetWindowHandle GetWindowHandle;
   pGetScreenWidth GetScreenWidth;
   pGetScreenHeight GetScreenHeight;
   pGetRenderWidth GetRenderWidth;
   pGetRenderHeight GetRenderHeight;
   ...
   pEnableEventWaiting EnableEventWaiting;
   pDisableEventWaiting DisableEventWaiting;
   ...
   pLoadRandomSequence LoadRandomSequence;
   pUnloadRandomSequence UnloadRandomSequence;
   ...
   pExportDataAsCode ExportDataAsCode;
   ...
   pGetApplicationDirectory GetApplicationDirectory;
   pChangeDirectory ChangeDirectory;
   pIsPathFile IsPathFile;
   pLoadDirectoryFiles LoadDirectoryFiles;
   pLoadDirectoryFilesEx LoadDirectoryFilesEx;
   pUnloadDirectoryFiles UnloadDirectoryFiles;
   pIsFileDropped IsFileDropped;
   pLoadDroppedFiles LoadDroppedFiles;
   pUnloadDroppedFiles UnloadDroppedFiles;
   ...
   pLoadAutomationEventList LoadAutomationEventList;
   pUnloadAutomationEventList UnloadAutomationEventList;
   pExportAutomationEventList ExportAutomationEventList;
   pSetAutomationEventList SetAutomationEventList;
   pSetAutomationEventBaseFrame SetAutomationEventBaseFrame;
   pStartAutomationEventRecording StartAutomationEventRecording;
   pStopAutomationEventRecording StopAutomationEventRecording;
   pPlayAutomationEvent PlayAutomationEvent;
   pIsKeyPressed IsKeyPressed;
   pIsKeyPressedRepeat IsKeyPressedRepeat;
   ...
   pGetMouseWheelMoveV GetMouseWheelMoveV;
   ...
   pDrawCircleLinesV DrawCircleLinesV;
   ...
   pDrawSplineLinear DrawSplineLinear;
   pDrawSplineBasis DrawSplineBasis;
   pDrawSplineCatmullRom DrawSplineCatmullRom;
   pDrawSplineBezierQuadratic DrawSplineBezierQuadratic;
   pDrawSplineBezierCubic DrawSplineBezierCubic;
   pDrawSplineSegmentLinear DrawSplineSegmentLinear;
   pDrawSplineSegmentBasis DrawSplineSegmentBasis;
   pDrawSplineSegmentCatmullRom DrawSplineSegmentCatmullRom;
   pDrawSplineSegmentBezierQuadratic DrawSplineSegmentBezierQuadratic;
   pDrawSplineSegmentBezierCubic DrawSplineSegmentBezierCubic;
   pGetSplinePointLinear GetSplinePointLinear;
   pGetSplinePointBasis GetSplinePointBasis;
   pGetSplinePointCatmullRom GetSplinePointCatmullRom;
   pGetSplinePointBezierQuad GetSplinePointBezierQuad;
   pGetSplinePointBezierCubic GetSplinePointBezierCubic;
   ...
   pExportImageToMemory ExportImageToMemory;
   pExportImageAsCode ExportImageAsCode;
   pGenImageColor GenImageColor;
   pGenImageGradientLinear GenImageGradientLinear;
   pGenImageGradientRadial GenImageGradientRadial;
   pGenImageGradientSquare GenImageGradientSquare;
   ...
   pExportFontAsCode ExportFontAsCode;
   pDrawFPS DrawFPS;
   pDrawText DrawText;
   pDrawTextEx DrawTextEx;
   pDrawTextPro DrawTextPro;
   pDrawTextCodepoint DrawTextCodepoint;
   pDrawTextCodepoints DrawTextCodepoints;
   pSetTextLineSpacing SetTextLineSpacing;
   ...
   pSetAudioStreamPan SetAudioStreamPan;
...
RaylibSupport loadRaylib(const(char)* libName) {
   ...
   lib.bindSymbol(cast(void**)&ToggleBorderlessWindowed, "ToggleBorderlessWindowed");
   ...
   lib.bindSymbol(cast(void**)&SetWindowMaxSize, "SetWindowMaxSize");
   lib.bindSymbol(cast(void**)&SetWindowSize, "SetWindowSize");
   lib.bindSymbol(cast(void**)&SetWindowOpacity, "SetWindowOpacity");
   lib.bindSymbol(cast(void**)&SetWindowFocused, "SetWindowFocused");
   ...
   lib.bindSymbol(cast(void**)&GetRenderWidth, "GetRenderWidth");
   lib.bindSymbol(cast(void**)&GetRenderHeight, "GetRenderHeight");
   ...
   lib.bindSymbol(cast(void**)&EnableEventWaiting, "EnableEventWaiting");
   lib.bindSymbol(cast(void**)&DisableEventWaiting, "DisableEventWaiting");
   ...
   lib.bindSymbol(cast(void**)&LoadRandomSequence, "LoadRandomSequence");
   lib.bindSymbol(cast(void**)&UnloadRandomSequence, "UnloadRandomSequence");
   ...
   lib.bindSymbol(cast(void**)&ExportDataAsCode, "ExportDataAsCode");
   ...
   lib.bindSymbol(cast(void**)&GetFileLength, "GetFileLength");
   ...
   lib.bindSymbol(cast(void**)&GetApplicationDirectory, "GetApplicationDirectory");
   lib.bindSymbol(cast(void**)&ChangeDirectory, "ChangeDirectory");
   lib.bindSymbol(cast(void**)&IsPathFile, "IsPathFile");
   lib.bindSymbol(cast(void**)&LoadDirectoryFiles, "LoadDirectoryFiles");
   lib.bindSymbol(cast(void**)&LoadDirectoryFilesEx, "LoadDirectoryFilesEx");
   lib.bindSymbol(cast(void**)&UnloadDirectoryFiles, "UnloadDirectoryFiles");
   lib.bindSymbol(cast(void**)&IsFileDropped, "IsFileDropped");
   lib.bindSymbol(cast(void**)&LoadDroppedFiles, "LoadDroppedFiles");
   lib.bindSymbol(cast(void**)&UnloadDroppedFiles, "UnloadDroppedFiles");
   ...
   lib.bindSymbol(cast(void**)&LoadAutomationEventList, "LoadAutomationEventList");
   lib.bindSymbol(cast(void**)&UnloadAutomationEventList, "UnloadAutomationEventList");
   lib.bindSymbol(cast(void**)&ExportAutomationEventList, "ExportAutomationEventList");
   lib.bindSymbol(cast(void**)&SetAutomationEventList, "SetAutomationEventList");
   lib.bindSymbol(cast(void**)&SetAutomationEventBaseFrame, "SetAutomationEventBaseFrame");
   lib.bindSymbol(cast(void**)&StartAutomationEventRecording, "StartAutomationEventRecording");
   lib.bindSymbol(cast(void**)&StopAutomationEventRecording, "StopAutomationEventRecording");
   lib.bindSymbol(cast(void**)&PlayAutomationEvent, "PlayAutomationEvent");
   lib.bindSymbol(cast(void**)&IsKeyPressed, "IsKeyPressed");
   lib.bindSymbol(cast(void**)&IsKeyPressedRepeat, "IsKeyPressedRepeat");
   ...
   lib.bindSymbol(cast(void**)&GetMouseWheelMoveV, "GetMouseWheelMoveV");
   ...
   lib.bindSymbol(cast(void**)&DrawCircleLinesV, "DrawCircleLinesV");
   ...
   lib.bindSymbol(cast(void**)&DrawSplineLinear, "DrawSplineLinear");
   lib.bindSymbol(cast(void**)&DrawSplineBasis, "DrawSplineBasis");
   lib.bindSymbol(cast(void**)&DrawSplineCatmullRom, "DrawSplineCatmullRom");
   lib.bindSymbol(cast(void**)&DrawSplineBezierQuadratic, "DrawSplineBezierQuadratic");
   lib.bindSymbol(cast(void**)&DrawSplineBezierCubic, "DrawSplineBezierCubic");
   lib.bindSymbol(cast(void**)&DrawSplineSegmentLinear, "DrawSplineSegmentLinear");
   lib.bindSymbol(cast(void**)&DrawSplineSegmentBasis, "DrawSplineSegmentBasis");
   lib.bindSymbol(cast(void**)&DrawSplineSegmentCatmullRom, "DrawSplineSegmentCatmullRom");
   lib.bindSymbol(cast(void**)&DrawSplineSegmentBezierQuadratic, "DrawSplineSegmentBezierQuadratic");
   lib.bindSymbol(cast(void**)&DrawSplineSegmentBezierCubic, "DrawSplineSegmentBezierCubic");
   lib.bindSymbol(cast(void**)&GetSplinePointLinear, "GetSplinePointLinear");
   lib.bindSymbol(cast(void**)&GetSplinePointBasis, "GetSplinePointBasis");
   lib.bindSymbol(cast(void**)&GetSplinePointCatmullRom, "GetSplinePointCatmullRom");
   lib.bindSymbol(cast(void**)&GetSplinePointBezierQuad, "GetSplinePointBezierQuad");
   lib.bindSymbol(cast(void**)&GetSplinePointBezierCubic, "GetSplinePointBezierCubic");
   ...
   lib.bindSymbol(cast(void**)&LoadImageSvg, "LoadImageSvg");
   ...
   lib.bindSymbol(cast(void**)&ExportImageToMemory, "ExportImageToMemory");
   lib.bindSymbol(cast(void**)&ExportImageAsCode, "ExportImageAsCode");
   lib.bindSymbol(cast(void**)&GenImageColor, "GenImageColor");
   lib.bindSymbol(cast(void**)&GenImageGradientLinear, "GenImageGradientLinear");
   lib.bindSymbol(cast(void**)&GenImageGradientRadial, "GenImageGradientRadial");
   lib.bindSymbol(cast(void**)&GenImageGradientSquare, "GenImageGradientSquare");
   ...
   lib.bindSymbol(cast(void**)&ImageRotate, "ImageRotate");
   ...
   lib.bindSymbol(cast(void**)&ExportFontAsCode, "ExportFontAsCode");
   ...
   lib.bindSymbol(cast(void**)&DrawTextCodepoints, "DrawTextCodepoints");
   lib.bindSymbol(cast(void**)&SetTextLineSpacing, "SetTextLineSpacing");
   ...
   lib.bindSymbol(cast(void**)&GetMasterVolume, "GetMasterVolume");
   ...
   lib.bindSymbol(cast(void**)&LoadSoundAlias, "LoadSoundAlias");
   ...
   lib.bindSymbol(cast(void**)&UnloadSoundAlias, "UnloadSoundAlias");
   ...
   lib.bindSymbol(cast(void**)&SetSoundPan, "SetSoundPan");
   ...
   lib.bindSymbol(cast(void**)&SetMusicPan, "SetMusicPan");
   ...
   lib.bindSymbol(cast(void**)&SetAudioStreamPan, "SetAudioStreamPan");
