...
void main(string[] args) {
   ...
   if (retVal != raylibSupport) {
      ...
      Font fontBm = LoadFont("resources/droidsans32.fnt");

      // TTF font : Font data and atlas are generated directly from TTF
      // NOTE: We define a font base size of 32 pixels tall and up-to 250 characters
      int* fontsChars;
      Font fontTtf = LoadFontEx("resources/DroidSansMono.ttf", 32, fontsChars, 250);
      trace("load tft");
      ...
      while (!WindowShouldClose()) {
         ...
         if (!useTtf) {
            DrawTextEx(fontBm, msg.toStringz, Vector2(20.0f, 100.0f), fontBm.baseSize, 2, MAROON);
            DrawText("Using BMFont (Angelcode) imported", 20, GetScreenHeight() - 30, 20, GRAY);
         } else {
            DrawTextEx(fontTtf, msg.toStringz, Vector2(20.0f, 100.0f), fontTtf.baseSize, 2, LIME);
